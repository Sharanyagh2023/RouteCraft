    ...
    <div className="max-w-[420px] mx-auto h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col px-6 py-8 z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-black tracking-tighter text-foreground">Get Started</h1>
          <p className="text-sm text-muted-foreground mt-2">Create your account to start planning smarter trips.</p>
        </motion.div>
